...
public final class PackDependency {
     ...
     * instance utilized a version range or a regular version.
     */
     ...
     * from a <code>TracedCollection</code> instance. This version WILL retrieve the
     * version.
     * 
    ...
    /**
     * Determines if the an <code>Identifier</code> instance has the same identifier
    ...
    /**
     * Determines if the version bounds of this <code>PackDependency</code> instance
    ...
    /**
     * Tests if an identifier matches with this <code>PackDependency</code>
     * instance.
     * 
     ...
     *         parameter matches with this <code>PackDependency</code> instance.
     */
     ...
     *         perameter.
     */
    public HashSet<Identifier> getMatches(Collection<Identifier> identifiers) {

        HashSet<Identifier> overlapping = new HashSet<>(
                identifiers.stream().filter(t -> matches(t)).collect(Collectors.toSet()));
     ...
     * bounds (or version perameter) matches with this <code>PackDependency</code>
     * instance version bounds (or version perameter).
     * 
     ...
     */
    public boolean matches(PackDependency dependency, boolean ignoreVersions) {
        ...
        if (dependency.hasVersionRange) {
            ...
            if (!hasVersionRange) {
                ...
                return dependency.matches(identifier);
            }

            // Use the system of equality v1 < V2 && V1 < v2 to determine if the 2 ranges
            // overlap.
            ...
            return matches(dependency.identifier);
        }
    }
     ...
     *         <b>OR</b> <br>
     *         "<code>namespace:identifier [a, b, c]</code>" <br>
     *         <b>OR</b> <br>
     *         "<code>namspace:identifier {[a, b, c], [?, ?, ?]}</code>" <br>
     *         <b>OR</b> <br>
