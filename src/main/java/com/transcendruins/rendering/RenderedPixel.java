...
public final class RenderedPixel {
    ...
    /**
     * <code>Sortert&lt;Double*gt;</code>: The sorter used to sort depths in a
     ...
     * 
     * @param foreground_rgba <code>int</code>: The RGBA color associated with the
     *                        foreground pixel.
     * @param background_rgba <code>int</code>: The RGBA color associated with the
     *                        background pixel.
    ...
    private int mergeRGB(int foreground_rgba, int background_rgba) {
        ...
        int outRed = (foregroundAlpha * ((foreground_rgba >> 16) & 0xFF) + nextPct * ((background_rgba >> 16) & 0xFF))
                / outAlpha;
        int outGreen = (foregroundAlpha * ((foreground_rgba >> 8) & 0xFF) + nextPct * ((background_rgba >> 8) & 0xFF))
                / outAlpha;
