...
/**
 * <code>ElementPresets</code>: A class representing the presets of an element.
 */
public final class ElementPresets extends AssetPresets {
     ...
     *                   this <code>ElementPresets</code> instance should be
     *                   created.
     ...
     */
    private ElementPresets(TracedCollection collection, Object key) throws LoggedException {

        super(collection, key, AssetType.ELEMENT);
    }
     ...
     *                        which
     *                        the new <code>ElementPresets</code> instance should be
     *                        created.
     * @param key             <code>Object</code>: The key to retrieve from the
     *                        <code>collection</code> parameter.
     ...
     *                        <code>ElementPresets</code> instance.
     * @return <code>ElementPresets</code>: The generated presets, or
     ...
     *                         new <code>ElementPresets</code> instance.
     */
    public static ElementPresets createPresets(TracedCollection collection, Object key, boolean nullCaseAllowed)
        ...
        return new ElementPresets(collection, key);
    }
}
