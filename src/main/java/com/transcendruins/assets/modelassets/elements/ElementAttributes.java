...
/**
 * <code>ElementAttributes</code>: A class which represents the attributes
 * of an <code>ElementSchema</code> instance.
 */
public final class ElementAttributes extends ModelAssetAttributes {

    /**
     * <code>Boolean</code>: Whether or not the rotation of this
     * <code>ElementAttributes</code> instance should snap to the four
     * cardinal directions.
     */
     ...
     *               compile this <code>ElementAttributes</code> instance.
     * @param isBase <code>boolean</code>: Whether or not this
     *               <code>ElementAttributes</code> instance is the base
     ...
     */
    public ElementAttributes(AssetSchema schema, TracedDictionary json, boolean isBase)
