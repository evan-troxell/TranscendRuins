...
public final class InventoryInstance extends Instance {
     ...
     * 
     * @param gridSize <code>int</code>: The grid size to copy.
     * @return <code>InventorySlot[]</code>: The resized grid.
     */
    public InventorySlotInstance[] copyContents(int gridSize) {

        InventorySlotInstance[] newGrid = new InventorySlotInstance[gridSize];
    ...
    public void applyAttributes(Attributes attributeSet) {
        ...
        gridSize = calculateAttribute(attributes.getGridSlots(), grid.length, attributes, 0);
        resize(gridSize);
