...
/**
 * <code>InterfaceAttributes</code>: A class which represents the
 * attributes of a <code>InterfaceSchema</code> instance.
 */
public final class InterfaceAttributes extends AssetAttributes {

    /**
     * Compiles this <code>InterfaceAttributes</code> instance into a
     * completed instance.
     * 
     ...
     *               compile this <code>InterfaceAttributes</code>
     *               instance.
     * @param isBase <code>boolean</code>: Whether or not this
     *               <code>InterfaceAttributes</code> instance is the
     ...
     *                         this <code>InterfaceAttributes</code> instance.
     */
    public InterfaceAttributes(AssetSchema schema, TracedDictionary json, boolean isBase)
