...
/**
 * <code>LayoutPresets</code>: A class representing the presets of a
 * layout.
 */
public final class LayoutPresets extends AssetPresets {

    /**
     * Creates a new instance of the <code>LayoutPresets</code> class.
     * 
     * @param collection <code>TracedCollection</code>: The collection from which
     *                   this <code>LayoutPresets</code> instance should be
     *                   created.
     ...
     *                         <code>LayoutPresets</code> instance.
     */
    private LayoutPresets(TracedCollection collection, Object key) throws LoggedException {

        super(collection, key, AssetType.LAYOUT);
    }
     ...
     *                        which
     *                        the new <code>LayoutPresets</code> instance should
     *                        be
     *                        created.
     * @param key             <code>Object</code>: The key to retrieve from the
     *                        <code>collection</code> parameter.
     ...
     *                        <code>LayoutPresets</code> instance.
     * @return <code>LayoutPresets</code>: The generated presets, or
     ...
     *                         new <code>LayoutPresets</code> instance.
     */
    public static LayoutPresets createPresets(TracedCollection collection, Object key, boolean nullCaseAllowed)
        ...
        return new LayoutPresets(collection, key);
    }
}
