...
public final class InventorySchema extends Attributes {
    ...
    public InventorySchema(TracedDictionary json, boolean isBase) throws LoggedException {
        ...
        if (gridEntry.containsValue()) {
            ...
            TracedEntry<Integer> gridSlotsEntry = gridJson.getAsInteger("slots", true, null, num -> num >= 0);
        ...
        if (namedEntry.containsValue()) {
            ...
            for (String slotName : namedJson) {
                ...
                if (slotName.matches(INDEX_PATTERN)) {
                    ...
                    throw new KeyNameException(namedJson, slotName);
                }
