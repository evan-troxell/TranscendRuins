...
/**
 * <code>AnimationPresets</code>: A class representing the presets of
 * an animation.
 */
public final class AnimationPresets extends AssetPresets {
     ...
     *                   this <code>AnimationPresets</code> instance
     *                   should be
     *                   created.
     ...
     */
    private AnimationPresets(TracedCollection collection, Object key) throws LoggedException {

        super(collection, key, AssetType.ANIMATION);
    }
     ...
     *                        which
     *                        the new <code>AnimationPresets</code> instance should
     *                        be
     *                        created.
     * @param key             <code>Object</code>: The key to retrieve from the
     *                        <code>collection</code> parameter.
     ...
     *                        <code>AnimationPresets</code> instance.
     * @return <code>AnimationPresets</code>: The generated presets, or
     ...
     *                         new <code>AnimationPresets</code> instance.
     */
    public static AnimationPresets createPresets(TracedCollection collection, Object key, boolean nullCaseAllowed)
        ...
        return new AnimationPresets(collection, key);
    }
}
