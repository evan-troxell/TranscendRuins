...
/**
 * <code>RecipeAttributes</code>: A class which represents the
 * attributes of a <code>RecipeSchema</code> instance.
 */
public final class RecipeAttributes extends AssetAttributes {

    /**
     * Compiles this <code>RecipeAttributes</code> instance into a
     * completed instance.
     * 
     ...
     *               compile this <code>RecipeAttributes</code>
     *               instance.
     * @param isBase <code>boolean</code>: Whether or not this
     *               <code>RecipeAttributes</code> instance is the
     ...
     *                         this <code>RecipeAttributes</code>
     *                         instance.
     */
    public RecipeAttributes(AssetSchema schema, TracedDictionary json, boolean isBase)
