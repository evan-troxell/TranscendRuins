...
/**
 * <code>ContentModule</code>: A class representing the module information of an
 * asset pack or resource pack.
 */
public abstract class ContentModule {

    /**
     * <code>TracedPath</code>: The directory of the root folder of this
     * <code>ContentModule</code> instance.
     */
    private final TracedPath root;

    /**
     * Retrieves the root of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * Retrieves the JSON information of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * <code>Identifier</code>: The identifier of this <code>ContentModule</code>
     * instance.
     */
    private final Identifier identifier;

    /**
     * Retrieves the identifier of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * <code>String</code>: The name of this <code>ContentModule</code> instance.
     */
    private final String name;

    /**
     * Retrieves the name of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * <code>String</code>: The description of this <code>ContentModule</code>
     * instance.
     */
    private final String description;

    /**
     * Retrieves the description of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * Retrieves the authors of this <code>ContentModule</code> instance.
     * 
     * @return <code>ImmutableList&lt;String&gt;</code>: The <code>authors</code>
     *         field of this <code>ContentModule</code> instance.
     */
    ...
    /**
     * <code>ImageIcon</code>: The display icon of this <code>ContentModule</code>
     * instance.
     */
    private final ImageIcon displayIcon;

    /**
     * Retrieves the display icon of this <code>ContentModule</code> instance.
     * 
    ...
    /**
     * Creates a new instance of the <code>ContentModule</code> class.
     * 
     * @param root <code>TracedPath</code>: The pathway to this
     *             <code>ContentModule</code>
     *             instance.
     * @throws LoggedException Thrown if any exception is raised while compiling
     *                         this <code>ContentModule</code> instance.
     */
    public ContentModule(TracedPath root) throws LoggedException {
    ...
    /**
     * Creates a new instance of the <code>ContentModule</code> from a schema
     * module.
     * 
     * @param schema <code>ContentModule</code>: The schema template to inherit
     *               from.
     */
    public ContentModule(ContentModule schema) {
    ...
    /**
     * Returns the string representation of this <code>ContentModule</code>
     * instance.
     * 
     * @return <code>String</code>: This <code>ContentModule</code> instance in the
