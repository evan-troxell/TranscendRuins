...
public final class RenderMaterialInstance extends AssetInstance {
     ...
     * 
     * @param schema <code>RenderMaterialPresets</code>: The presets used to
     *               generate
     *               this <code>RenderMaterialInstance</code> instance.
     * @param world  <code>World</code>: The world copy to assign to this
     *               <code>RenderMaterialInstance</code> instance.
     */
    public RenderMaterialInstance(RenderMaterialPresets presets, World world) {

        super(presets, world);
    }

    /**
     * Applies an attribute set to this <code>RenderMaterialInstance</code>
     * instance.
     * 
