...
/**
 * <code>SettingsPanel</code>: A class which represents a settings panel in the
 * UI.
 */
public abstract class SettingsPanel extends TRPanel {
     ...
     *                 <code>SettingsPanel</code> instance.
    ...
    public SettingsPanel(String name, ComponentSettings settings) {
        ...
        TRButton exitButton = new TRButton(DisplayFrame.EXIT_BUTTON, "< Settings", new Dimension(95, 35),
                ComponentSettings.DEFAULT_LABEL_SETTINGS) {
        ...
        TRPanel menuContentPanel = new TRPanel("menuContentpanel", new BorderLayout(),
                ComponentSettings.HIDDEN_COMPONENT_SETTINGS);

        TRScreenPanel menuDisplayPanel = new TRScreenPanel("menuDisplayPanel",
                ComponentSettings.HIDDEN_COMPONENT_SETTINGS);
        ...
        TRPanel menuSelectionPanel = TRPanel.createBoxPanel("menuSelectionPanel", menuSelectionPanelComponents, true,
                LEFT_ALIGNMENT, 15, ComponentSettings.BACKGROUND_PANEL_SETTINGS, false);
