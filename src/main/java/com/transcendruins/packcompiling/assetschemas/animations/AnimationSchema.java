...
/**
 * <code>AnimationSchema</code>: A class which serves as the schema template for
 * an animation class, created into the parent <code>Pack</code> instance.
 */
public final class AnimationSchema extends AssetSchema {
     ...
     *             <code>AnimationSchema</code> instance.
    ...
    @Override
    public AnimationSchemaAttributes buildAttributeSet(TracedDictionary jsonSchema, boolean isBase)
            throws LoggedException {

        return new AnimationSchemaAttributes(this, jsonSchema, isBase);
    }
}
