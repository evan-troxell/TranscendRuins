...
/**
* <code>AnimationSchemaComponents</code>: A class which represents the components of an <code>AnimationSchema</code> instance.
*/
public final class AnimationSchemaComponents extends AssetSchemaComponents {
    ...
    /**
     * <code>Double</code>: The animation length of this <code>AnimationSchemaComponents</code> instance in seconds.
     */
    private final Double length;

    /**
     * <code>HashMap&lt;Double, HashMap&lt;String, AnimationSchemaComponents.KeyFrame&gt;&gt;</code>: The key frame time stamps of this <code>AnimationSchemaComponents</code> instance paired with the key frames of the bone actors.
     */
    private final HashMap<Double, HashMap<String, KeyFrame>> keyFrames = new HashMap<>();

    /**
     * <code>ArrayList&lt;Double&gt;</code>: The sorted list of timestamps of this <code>AnimationSchemaComponents</code> instance.
     */
    private final ArrayList<Double> timestampsSorted;

    /**
     * <code>HashSet&lt;String&gt</code>: The set of all bones of this <code>AnimationSchemaComponents</code> instance.
     */
    private final HashSet<String> bones;

    /**
     * <code>boolean</code>: Whether or not this <code>AnimationSchemaComponents</code> defines a new animation or only properties of the animation.
     */
    private final boolean animationDefinition;

    /**
     * Compiles this <code>AnimationSchemaComponents</code> instance into a completed instance.
     * @param schema <code>AnimationSchema</code>: The schema which created this <code>AnimationSchemaComponents</code> instance.
     * @param schemaJson <code>TracedDictionary</code>: The schema JSON used to compile this <code>AnimationSchemaComponents</code> instance.
     * @param isBase <code>boolean</code>: Whether or not this <code>AnimationSchemaComponents</code> instance is the base component set of an <code>AnimationSchema</code> instance.
     * @throws LoggedException Thrown if an exception is raised while processing this <code>AnimationSchemaComponents</code> instance.
     */
    public AnimationSchemaComponents(AnimationSchema schema, TracedDictionary schemaJson, boolean isBase) throws LoggedException {

        super(schema, schemaJson, isBase);

        // Key frames should be required if this component set is the base component set.
        ...
        if (keyframesJson != null) {
            ...
            // Sort the list of timestamps and apply it to this component set.
    ...
    /**
     * <code>AnimationSchemaComponents.KeyFrame</code>: A class representing a keyframe in an animation.
     */
    public final class KeyFrame {
         ...
         * @param keyframeJson <code>TracedDictionary</code>: The json from which this <code>AnimationSchemaComponents.KeyFrame</code> instance should be constructed.
         * @param timestamp <code>double</code>: The timestamp of this <code>AnimationSchemaComponents.KeyFrame</code> instance.
