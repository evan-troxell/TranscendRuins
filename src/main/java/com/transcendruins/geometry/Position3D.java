...
/**
 * <code>Position3D</code>: A class representing a position and orientation in 3D space.
 */
public class Position3D {
    ...
    /**
     * <code>double</code>: The heading of this <code>Position3D</code> instance, specified in radians.
     */
    ...
    /**
     * <code>double</code>: The pitch of this <code>Position3D</code> instance, specified in radians.
     */
    ...
    /**
     * <code>MatrixOperations</code>: The operations used to normalize a polygon to the position and orientation of this <code>Position3D</code> instance.
     */
    private MatrixOperations renderTransform;

    /**
     * Creates a new instance of the <code>Position3D</code> class whose position is centered around the origin.
     */
    public Position3D() {
    ...
    public final boolean setPositionBounds(Vector min, Vector max) {
        ...
        if (min != null && max != null && (min.getX() > max.getX() || min.getY() > max.getY() || min.getZ() > max.getZ())) {
     ...
     * @param maxPitch <code>Double</code>: The maximum pitch boundary of this <code>Position3D</code> instance. A null value represents no boundary being assigned.
     * @param isRadians <code>boolean</code>: Whether or not the <code>heading</code> and <code>pitch</code> perameters are specified in radians.
     * @return <code>boolean</code>: Whether or not the boundaries were successfully applied to this <code>Position3D</code> instance.
     */
    public final boolean setRotationalBounds(Double minHeading, Double maxHeading, Double minPitch, Double maxPitch, boolean isRadians) {
    ...
    protected void update() {
        ...
        // Because the heading transform already accounted for rotation about the y axis, all vectors will now be adjusted to the x axis as if the x axis was orthagonal to the orientation.
        // Thus, the only necessary transformation is rotation about the X axis to account for pitch.
        Matrix pitchTransform = Matrix.getRotationalMatrix3X3(-getPitch(), Matrix.X_AXIS);

        // Combines the 'headingTransform' and 'pitchTransform' matrices into a single axis-aligning matrix.
