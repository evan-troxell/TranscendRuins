...
/**
 * <code>UnexpectedValueException</code>: An exception thrown to indicate a
 * retrieved entry has an unexpected value.
 */
public final class UnexpectedValueException extends PropertyException {

    /**
     * Creates a new instance of the <code>UnexpectedValueException</code>
     * exception.
     * 
    ...
    public UnexpectedValueException(TracedEntry<?> entry) {
        ...
        super(propertyName(entry) + " is the unexpected value " + entry.getValue() + ".", entry,
