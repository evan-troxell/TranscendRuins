...
/**
 * <code>VersionBoundsException</code>: An exception thrown to indicate an invalid version bounds.
 */
public final class VersionBoundsException extends PropertyException {
    ...
    public static VersionBoundsException inverseMaxAndMinBounds(TracedEntry<Identifier> maxVersion, TracedEntry<Identifier> minVersion) {
        ...
        return new VersionBoundsException("Maximum version " + maxVersion.getValue().version + " may not be lower than minimum version " + minVersion.getValue().version + ".", maxVersion);
    }
}
