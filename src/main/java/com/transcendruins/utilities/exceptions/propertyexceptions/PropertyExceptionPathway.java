...
/**
 * <code>PropertyExceptionPathway</code>: A class representing the pathway of a property exception within the retrieved file.
 */
public final class PropertyExceptionPathway {
     ...
     * @return <code>String</code>: The string representation of the pathway traced by the <code>collection</code> property of this <code>PropertyExceptionPathway</code> instance.
     */
    @Override
