...
/**
 * <code>InvalidDependencyException</code>: An exception thrown to indicate an invalid dependency.
 */
public final class InvalidDependencyException extends DependencyException {
     ...
     */
    public static InvalidDependencyException overlappingDependencies(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency, HashSet<TracedEntry<Metadata>> overlappingDependencies) {
     ...
     * @return <code>InvalidDependencyException</code>: The generated <code>InvalidDependencyException</code> exception.
     */
    public static InvalidDependencyException overlapsPackIdentifier(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency) {
     ...
     * @return <code>InvalidDependencyException</code>: The generated <code>InvalidDependencyException</code> exception.
     */
    public static InvalidDependencyException incompatibleDependencyVersions(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency, TracedEntry<Metadata> incompatibleDependency) {

        String message = DependencyException.dependencyName(dependency);
        message += " is incompatible with the version" + ((incompatibleDependency.getValue().versionRange ? "s" : "")) + " of dependency " + incompatibleDependency + ". Note that this exception may have been caused by a sub-dependency.";
     ...
     * @return <code>InvalidDependencyException</code>: The generated <code>InvalidDependencyException</code> exception.
     */
    public static InvalidDependencyException divergingDependencies(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency) {
     ...
     * @return <code>InvalidDependencyException</code>: The generated <code>InvalidDependencyException</code> exception.
     */
    public static InvalidDependencyException divergingDependencies(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency, TracedEntry<Metadata> incompatibleDependency) {

        String message = dependencyName(dependency);

        message += " references one or more pack versions which require different dependencies from those of dependency " + incompatibleDependency + ". Note that this exception may have been caused by a sub-dependency.";

        return new InvalidDependencyException(message, entry);
    }

    public static InvalidDependencyException missingDependencies(TracedEntry<TracedArray> entry, TracedEntry<Metadata> dependency, Collection<TracedEntry<Metadata>> dependencies) {
