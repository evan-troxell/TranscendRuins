...
/**
 * <code>DependencyException</code>: An exception thrown to indicate a dependency exception.
 */
public class DependencyException extends PropertyException {
     ...
     * @param dependency <code>TracedEntry&lt;Metadata&gt;</code>: The dependency to check.
     * @return <code>String</code>: The <code>dependency</code> perameter in the following string representation: <br>"<code>Dependency namespace:identifier</code>"
     * <br> <b>OR</b> <br> "<code>Dependency namespace:identifier [a, b, c]</code>"
     * <br> <b>OR</b> <br> "<code>Dependency namespace:identifier with minimum version [a, b, c]</code>"
     * <br> <b>OR</b> <br> "<code>Dependency namespace:identifier with version range [a, b, c] to [d, e, f]</code>"
     */
    public static final String dependencyName(TracedEntry<Metadata> dependency) {
        ...
        if (metadata.versionRange) {
            ...
            if (metadata.versionBounds[1] == null) {

                message += " with minimum version " + metadata.versionBounds[0].version;
            } else {

                message += " with version range " + metadata.versionBounds[0].version + " to " + metadata.versionBounds[1].version;
            }
        }
