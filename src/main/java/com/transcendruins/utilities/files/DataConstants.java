...
public final class DataConstants {
        ...
        public static final Identifier VANILLA_IDENTIFIER;
        ...
        public static final String INVENTORY_SLOT_ICON = "interface.inventory.slot";

        public static final String INVENTORY_SLOT_SELECTED_ICON = "interface.inventory.slotSelected";
        ...
        static {
                ...
                try {
                        ...
                        TracedEntry<Identifier> vanillaIdentifierEntry = constantsJson
                                        .getAsMetadata("vanillaIdentifier", false, true);
                        VANILLA_IDENTIFIER = vanillaIdentifierEntry.getValue();

                        TracedEntry<AssetPresets> playerIdentifierEntry = constantsJson.getAsPresets("playerIdentifier",
                                        false, AssetType.ENTITY);
                        PLAYER_IDENTIFIER = playerIdentifierEntry.getValue();

                        TracedEntry<AssetPresets> globalMapIdentifierEntry = constantsJson
                                        .getAsPresets("globalMapIdentifier", false, AssetType.INTERFACE);
