...
/**
 * <code>TracedArray</code>: A class representing an array whose <code>parent.get()</code> method has been traced.
 */
public final class TracedArray extends TracedCollection {

    /**
     * The stored JSON array information which this </code>TracedArray</code> draws from.
     */
    ...
    /**
     * Retrieves the JSONArray object used as the collection method of this <code>TracedArray</code> instance method.
     * @return <code>JSONArray</code>: The <code>JSONArray</code> representing the stored list of this collection.
     */
    @Override
    ...
    /**
     * Retrieve a value from this <code>TracedArray</code> instance using a specific key.
    ...
    /**
     * Determines whether or not this <code>TracedArray</code> instance contains a specific key.
     * @param key <code>Object</code>: The key to apply.
     * @return <code>boolean</code>: Whether or not this <code>TracedArray</code> instance contains the applied key.
     */
    @Override
    ...
    /**
     * Determines whether or not this <code>TracedArray</code> instance contains a specific value.
     * @param value <code>Object</code>: The value to apply.
     * @return <code>boolean</code>: Whether or not this <code>TracedArray</code> instance contains the applied value.
     */
    @Override
