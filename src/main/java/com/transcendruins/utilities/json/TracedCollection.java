...
/**
 * <code>TracedCollection</code>: A parent class representing a colection whose
 * <code>parent.get()</code> method has been traced.
 */
public abstract class TracedCollection {

    /**
     * <code>PropertyExceptionPathway</code>: The filepath to this
     * <code>TracedCollection</code> instance.
     */
    private final PropertyExceptionPathway path;

    /**
     * Retrieves the path of this <code>TracedCollection</code> instance.
     * 
     * @return <code>PropertyExceptionPathway</code>: The <code>path</code> field of
     *         this <code>TracedCollection</code> instance.
     */
    public PropertyExceptionPathway getPath() {

        return path;
    }

    /**
     * <code>ArrayList&lt;Object&gt;</code>: The path traced to this
     * <code>TracedCollection</code> from inside the JSON file.
     */
    ...
    public TracedCollection(PropertyExceptionPathway path) {
        ...
        // Create a duplicate of the internal path of the 'path' perameter to avoid
        // modifying the original.
        internalPath = new ArrayList<>(path.getCollection().internalPath);
        extend(path.getKey());
    }
     ...
     * 
     * @param key             <code>Object</code>: The key to check for in this
     *                        <code>TracedCollection</code> instance.
     * @param nullCaseAllowed <code>boolean</code>: Whether or not a
     *                        <code>null</code> case should cause an exception.
     * @param classes         <code>Class...</code>: All classes which the entry can
     *                        be an instance of.
     * @return <code>Clas&lt;?&gt;</code>: The class of the entry tested in this
     *         <code>TracedCollection</code> instance.
     * @throws MissingPropertyException Thrown if the entry is missing and the
     *                                  <code>nullCaseAllowed</code> perameter is
     *                                  <code>false</code>.
     * @throws PropertyTypeException    Thrown if the entry is of an invalid type.
     */
    public final Class<?> retrieveRequiredClass(Object key, boolean nullCaseAllowed, Class<?>... classes)
        ...
        PropertyExceptionPathway pathway = new PropertyExceptionPathway(path.getPath(), this, key);
     ...
     *                                  invalid type.
     */
    public final TracedEntry<?> get(Object key, boolean nullCaseAllowed, Object ifNull, Class<?>... classes)
            throws MissingPropertyException, PropertyTypeException {
        ...
        // If the null case is allowed and the value is null, return the ifNull value
        // instead of the retrieved entry.
        ...
        // An argument of no classes represents that any class is allowed, while an
        // argument of one or more classes indicates that the retrieved entry must be
        // one of them.
        if (classes.length > 0) {
     ...
     */
    public final TracedEntry<TracedDictionary> getAsDictionary(Object key, boolean nullCaseAllowed)
            throws MissingPropertyException, PropertyTypeException {
     ...
     *                        retrieve.
     * @return <code>TracedEntry&lt;TracedArray&gt;</code>: The vector retrieved
     ...
     *                                  the <code>nullCaseAllowed</code> perameter
     *                                  is <code>false</code>.
     * @throws ArrayLengthException     Thrown if the retrieved array does not have
     *                                  a length of <code>3</code>.
     */
    public final TracedEntry<Vector> getAsVector(Object key, boolean nullCaseAllowed, int dimensions)
            throws PropertyTypeException, MissingPropertyException, ArrayLengthException {
     ...
     *                        retrieved from this <code>TracedCollection</code>
     *                        instance is <code>null</code>.
     * @param min             <code>Long</code>: The minimum number bound. A
     *                        <code>null</code> value represents no minimum bounds.
     * @param max             <code>Long</code>: The maximum number bound. A
     *                        <code>null</code> value represents no maximum bounds.
     * @return <code>TracedEntry&lt;Long&gt;</code>: The long retrieved from this
     *         <code>TracedCollection</code> instance.
     * @throws MissingPropertyException Thrown if the retrieved field is missing and
     *                                  the <code>nullCaseAllowed</code> perameter
     ...
     * @throws PropertyTypeException    Thrown if the retrieved field is not of the
     *                                  <code>long</code> class.
     * @throws NumberBoundsException    Thrown if the retrieved field is less than
     *                                  the <code>min</code> perameter or greater
     *                                  than the <code>max</code> perameter.
     */
    public final TracedEntry<Long> getAsLong(Object key, boolean nullCaseAllowed, Long ifNull, Long min, Long max)
        ...
        // If the number is outside of the expected bounds (if any), throw an exception
        // stating such.
    ...
    public final TracedEntry<Double> getAsDouble(Object key, boolean nullCaseAllowed, Double ifNull)
        ...
        double num = (retrievedVal.getValue() instanceof Long) ? ((Long) retrievedVal.getValue()).doubleValue()
                : (double) retrievedVal.getValue();
        return new TracedEntry<>(retrievedVal.getPathway(), num);
    }
     ...
     *                        retrieved from this <code>TracedCollection</code>
     *                        instance is <code>null</code>.
     * @param min             <code>Double</code>: The minimum number bound. A
     *                        <code>null</code> value represents no minimum bounds.
     * @param max             <code>Double</code>: The maximum number bound. A
     *                        <code>null</code> value represents no maximum bounds.
     * @return <code>TracedEntry&lt;Double&gt;</code>: The double retrieved from
     *         this <code>TracedCollection</code> instance.
     * @throws MissingPropertyException Thrown if the retrieved field is missing and
     ...
     *                                  than the <code>max</code> perameter.
     */
    public final TracedEntry<Double> getAsDouble(Object key, boolean nullCaseAllowed, Double ifNull, Double min,
            Double max) throws MissingPropertyException, PropertyTypeException, NumberBoundsException {
     ...
     * @throws MissingPropertyException Thrown if the retrieved field is missing.
     * @throws ArrayLengthException     Thrown if the version vector does not have a
     *                                  length of 3.
    ...
    public final TracedEntry<Version> getAsVersion(Object key, boolean nullCaseAllowed,
            boolean negativeVectorValuesAllowed) throws ArrayLengthException, MissingPropertyException,
        ...
        return new TracedEntry<>(retrievedVal.getPathway(),
                Version.createVersion(retrievedVal, negativeVectorValuesAllowed));
    }

    /**
     * Retrieves a field from this <code>TracedCollection</code> instance and parses
     * it into a new <code>Metadata</code> instance. Note that the retrieved field
     * MUST be of the <code>JSONObject</code> class and cannot be null. This version
     * WILL retrieve the version.
     * 
     * @param key                 <code>Object</code>: The key whose entry to
     *                            retrieve in this <code>TracedCollection</code>
     *                            instance.
     * @param nullCaseAllowed     <code>boolean</code>: Whether or not a
     *                            <code>null</code> case should cause an exception.
     ...
     *                            instance.
     * @return <code>TracedEntry&lt;Metadata&gt;</code>: The metadata retrieved from
     *         this <code>TracedCollection</code> instance.
     * @throws PropertyTypeException     Thrown if the type of a field in this
     *                                   <code>Metadata</code> instance is invalid.
     * @throws MissingPropertyException  Thrown if the <code>key</code> perameter
     *                                   retrieved from this <code>Metadata</code>
     *                                   instance is missing.
     * @throws MissingPropertyException  Thrown if a field is missing from this
     *                                   <code>Metadata</code> instance.
     * @throws ArrayLengthException      Thrown if the version vector does not have
     *                                   a length of 3.
     * @throws IdentifierFormatException Thrown if the identifier field is in an
     *                                   improper format.
     * @throws VersionBoundsException    Thrown if the minimum version bounds is
     *                                   greater than the maximum version bounds in
     *                                   the generated <code>Metadata</code>
     *                                   instance.
     * @throws NumberBoundsException     Thrown if any vector value in the generated
     *                                   <code>Metadata</code> instance is negative.
     */
    public final TracedEntry<Metadata> getAsMetadata(Object key, boolean nullCaseAllowed, boolean versionRangeAllowed)
            throws ArrayLengthException, MissingPropertyException, PropertyTypeException, IdentifierFormatException,
            VersionBoundsException, NumberBoundsException {
     ...
     *                                   improper format.
     */
    public final TracedEntry<Metadata> getAsMetadata(Object key, boolean nullCaseAllowed)
            throws MissingPropertyException, PropertyTypeException, IdentifierFormatException {
    ...
    /**
     * Retrieves the storage method behind this <code>TracedCollection</code>
     * instance.
     */
