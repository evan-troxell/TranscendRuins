...
public final class StoredSound {
    ...
    /**
     * <code>StoredSound.PlayableSound</code>: The sound generated by this
    ...
    /**
     * <code>StoredSound.PlayableSound</code>: An interface representing a sound
     * which can be run.
     */
    ...
    /**
     * <code>StoredSound.ClipSound</code>: A class representing a sound stored in a
     * clip in memory.
     */
    private final class ClipSound implements PlayableSound {

        /**
         * <code>byte[]</code>: The audio data of this
         * <code>StoredSound.ClipSound</code> instance represented as a byte array.
         */
        private final byte[] audioData;

        /**
         * <code>AudioFormat</code>: The audio format of this
         * <code>StoredSound.ClipSound</code> instance.
         */
        private final AudioFormat format;

        /**
         * Creates a new instance of the <code>StoredSound.ClipSound</code> class.
         * 
         * @throws UnsupportedAudioFileException Thrown if the audio file is of an
         *                                       invalid format.
         * @throws IOException                   Thrown if the file could not be
    ...
    /**
     * <code>StoredSound.StreamSound</code>: A class representing a sound which
     * should be streamed from disk.
     */
