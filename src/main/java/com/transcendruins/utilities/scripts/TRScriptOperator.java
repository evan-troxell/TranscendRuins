...
final class TRScriptOperator {
    ...
    /**
     * <code>HashMap&lt;String, TRScriptOperator&gt;</code>: The set of all operators.
     */
    private static final HashMap<String, TRScriptOperator> OPERATORS = createOperators();

    /**
     * <code>(ArrayList&lt;TRScriptValue&gt;) -> Object</code>: The expression by which this <code>TRScriptOperator</code> instance should be evaluated.
     */
    private final Function<ArrayList<TRScriptValue>, Object> evaluate;

    /**
     * <code>(Integer) -> Boolean</code>: The expression by which the validity of arguments of this <code>TRScriptOperator</code> instance should be evaluated.
     */
    private final Function<Integer, Boolean> invalidArgs;

    /**
     * Creates a new instance of the <code>TRScriptOperator</code> class.
     * @param evaluate <code>(ArrayList&lt;TRScriptValue&gt;) -> Object)</code>: The expression by which this <code>TRScriptOperator</code> instance should be evaluated.
     * @param invalidArgs <code>(Integer) -> Boolean)</code>: The expression by which the validity of arguments of this <code>TRScriptOperator</code> instance should be evaluated.
     */
    public TRScriptOperator(Function<ArrayList<TRScriptValue>, Object> evaluate, Function<Integer, Boolean> invalidArgs) {
     ...
     * @param args <code>ArrayList&lt;TRScriptValue&gt;</code>: The arguments of this <code>TRScriptOperator</code> instance.
    ...
    /**
     * Evaluates whether or not the length of the arguments of this <code>TRScriptExpression</code> instance are invalid.
     * @param argsLength <code>int</code>: The length of the arguments of this <code>TRScriptOperator</code> instance.
     * @return <code>boolean</code>: Whether or not this <code>TRScriptOperator</code> instance has invalid arguments.
     */
     ...
     * @return <code>HashMap&lt;String, TRScriptOperator&gt;</code>: The resulting operators.
     */
     ...
     * @return <code>TRScriptOperator</code>: The identity operator in the <code>OPERATORS</code> field.
     */
     ...
     * @param operatorEntry <code>TracedEntry&lt;String&gt;</code>: The operator entry to parse.
     * @return <code>TRScriptOperator</code>: The operator in the <code>OPERATORS</code> field.
