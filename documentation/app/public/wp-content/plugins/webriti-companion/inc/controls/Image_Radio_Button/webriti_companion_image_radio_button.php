...
class Webriti_Companion_Image_Radio_Button extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style('webriti-companion-radio-image-button-custom-controls', WC__PLUGIN_URL . 'inc/controls/Image_radio_Button/css/customizer.css', [], WC_PLUGIN_VERSION);
    }
