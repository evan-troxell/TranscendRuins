...
if ( ! function_exists( 'webriti_companion_busiprof_testi' ) ) :

	function webriti_companion_busiprof_testi() {
		...
		if(empty($testimonial_options)){
			...
			$testimonial_options = wp_json_encode( array(
				array(
		...
		if( $current_options['home_testimonial_section_enabled']=='on' ) {
			...
			<section id="section" class="<?php echo esc_attr($testimonial_section_class); ?>">
				<div class="container">
					<!-- Section Title -->
					<div class="row">
						<div class="col-md-12">
							...
							if( $testimonial_options!='' ) {
								...
								for($i=0; $i<=3; $i++) { ?>
									<div class="col-md-12 pull-left item <?php if($i == 0) { echo 'active'; } ?>">
										<div class="post">
											<figure class="post-thumbnail">
												<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/<?php echo esc_attr($image[$i]); ?>.jpg" class="img-circle">
											</figure>
											<?php 
											if($testimonial_section_class == 'testimonial2 testimonial-scroll bg-color') { ?>
												<div class="media">
													<div class="media-body">
								...
								<div class="row">
									<div class="testi-pager">
										<ol class="carousel-indicators testi-pagi">
											<?php foreach($testimonial_options as $testimonial_iteam){ ?>
...
if ( function_exists( 'webriti_companion_busiprof_testi' ) ) {
	$section_priority = apply_filters( 'busiprof_section_priority', 11, 'webriti_companion_busiprof_testi' );
	add_action( 'busiprof_home_tesi_sections', 'webriti_companion_busiprof_testi', absint( $section_priority ) );
}