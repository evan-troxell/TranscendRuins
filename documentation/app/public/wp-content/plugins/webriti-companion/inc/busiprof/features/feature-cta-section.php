...
function webriti_companion_busiprof_cta_section( $wp_customize ) {
	...
	// Enable banner strip
	$wp_customize->add_setting( 'busiprof_theme_options[home_banner_strip_enabled]' , 
		array( 
			'default' => 'on' , 
			'type' => 'option', 
	...
	$wp_customize->add_control(	'busiprof_theme_options[home_banner_strip_enabled]' , 
		array(
	...
	$wp_customize->add_setting( 'busiprof_theme_options[slider_head_title]', 
		array( 
			'default' => esc_html__('Busiprof: Lorem ipsum dolor sit amet, consectetur adipiscing elit','webriti-companion'), 
			'type' => 'option', 
...
add_action( 'customize_register', 'webriti_companion_busiprof_cta_section' );