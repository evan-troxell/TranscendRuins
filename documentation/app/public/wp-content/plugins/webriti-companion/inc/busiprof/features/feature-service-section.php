...
function webriti_companion_busiprof_service_panel($wp_customize) {
    ...
    $wp_customize->add_setting('busiprof_theme_options[enable_services]', array(
        'default' => 'on', 
        'type' => 'option', 
    ...
    //Service Heading One
    $wp_customize->add_setting('busiprof_theme_options[service_heading_one]', array(
        'default' => __('Ligula Fringilla', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'wp_kses_post',
        'type' => 'option',
    ));
    $wp_customize->add_control('busiprof_theme_options[service_heading_one]', array(
    ...
    $wp_customize->add_setting('busiprof_theme_options[service_tagline]', array(
    ...
    $wp_customize->add_control('busiprof_theme_options[service_tagline]', array(
    ...
    $wp_customize->add_setting('busiprof_theme_options[service_button_value]', array(
        'default' => esc_html__('Etiam Cursus', 'webriti-companion'), 
        'type' => 'option', 
        'sanitize_callback' => 'busiprof_input_field_sanitize_text'
    ));
    $wp_customize->add_control('busiprof_theme_options[service_button_value]', array(
    ...
    $wp_customize->add_setting('busiprof_theme_options[service_link_btn]', array(
        'default' => '#', 
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw'
    ));
    $wp_customize->add_control('busiprof_theme_options[service_link_btn]', array(
...
add_action('customize_register', 'webriti_companion_busiprof_service_panel');

/**
 * Add selective refresh for service title section controls.
 */
function webriti_companion_busiprof_service_section_partials($wp_customize) {
...
add_action('customize_register', 'webriti_companion_busiprof_service_section_partials');
...
if ($theme->name == 'vdequator' && (version_compare(wp_get_theme()->get('Version'), '1.0.9') > 0)):
    ...
    if (!function_exists('webriti_companion_vdequator_service_layout_customizer')) {

        function webriti_companion_vdequator_service_layout_customizer($wp_customize) {
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[service_effect_layout_setting]', array(
    ...
    add_action('customize_register', 'webriti_companion_vdequator_service_layout_customizer');
...
if ($theme->name == 'LazyProf' && (version_compare(wp_get_theme()->get('Version'), '1.2.5') > 0)):
    ...
    if (!function_exists('webriti_companion_lazyprof_service_layout_customizer')) {

        function webriti_companion_lazyprof_service_layout_customizer($wp_customize) {
            $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data());
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[service_rotate_effect_layout_setting]', array(
                'label' => esc_html__('Service Layout Setting', 'webriti-companion'),
                'section' => 'services_section',
                'choices' => array(
                    'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_lazyprof_service_layout_customizer');
    
endif;

if ($theme->name == 'vdperanto' && (version_compare(wp_get_theme()->get('Version'), '2.0', '>='))):

    if (!function_exists('webriti_companion_vdperanto_service_layout_customizer')) {

        function webriti_companion_vdperanto_service_layout_customizer($wp_customize) {
            $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data());
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[service_blink_effect_layout_setting]', array(
                'label' => esc_html__('Service Layout Setting', 'webriti-companion'),
                'section' => 'services_section',
                'choices' => array(
                    'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_vdperanto_service_layout_customizer');
