...
if ( ! function_exists( 'webriti_companion_busi_service_default_customize_register' ) ) :
	function webriti_companion_busi_service_default_customize_register( $wp_customize ) {
		...
		{	
			...
			if($old_theme_servives['service_image_one']!= '' || $old_theme_servives['service_icon_one']!= '' || $old_theme_servives['service_title_one']!= '' || $old_theme_servives['service_text_one']!= '' || $old_theme_servives['service_image_two']!= '' || $old_theme_servives['service_icon_two']!= '' || $old_theme_servives['service_title_two']!= '' || $old_theme_servives['service_text_two']!= '' || $old_theme_servives['service_image_three']!= '' || $old_theme_servives['service_icon_three']!= '' || $old_theme_servives['service_title_three']!= '' || $old_theme_servives['service_text_three']!= '' ||$old_theme_servives['service_image_four']!= '' || $old_theme_servives['service_icon_four']!= '' || $old_theme_servives['service_title_four']!= '' || $old_theme_servives['service_text_four']!= '') {
				...
				if ( ! empty( $busiprof_service_content_control ) ) {
					$busiprof_service_content_control->default = wp_json_encode( array(
						array(
		...
		if ( ! empty( $busiprof_testimonial_content_control ) ) {
			$busiprof_testimonial_content_control->default = wp_json_encode( array(
				array(
					...
					'link'       => '#',
					'image_url'  => isset($testimonial_data['testimonials_image_one'])? $testimonial_data['testimonials_image_one']: esc_url(WC__PLUGIN_URL.'inc/busiprof/img/testimonial.jpg'),
					'id'         => 'customizer_repeater_56d7ea7f40b96',
					'open_new_tab' => 'no',
				),
				array(
					...
					'link'       => '#',
					'image_url'  => isset($testimonial_data['testimonials_image_two'])? $testimonial_data['testimonials_image_two']: esc_url(WC__PLUGIN_URL.'inc/busiprof/img/testimonial2.jpg'),
	...
	add_action( 'customize_register', 'webriti_companion_busi_service_default_customize_register' );
endif;