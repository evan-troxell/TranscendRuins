...
if ( ! function_exists( 'webriti_companion_busiprof_project' ) ) :
	function webriti_companion_busiprof_project() {	
			...
			<section id="section" class="portfolio bg-color">
				<div class="container">
					...
					<div class="tab-content main-portfolio-section" id="myTabContent">
						<!-- Portfolio Item -->
						<div class="row">
							<?php if(($project_thumb_one =='') && (empty($current_options['project_title_one'])) && (empty($current_options['project_text_one']))) { } 
							else { ?>
								<div class="col-md-3 col-sm-6 col-xs-12">
									<aside class="post">
										<figure class="post-thumbnail">
											...
											<?php } ?>
											<?php if($current_options['project_one_url']!='') {?> </a>	<?php } ?>
										</figure>
...
if ( function_exists( 'webriti_companion_busiprof_project' ) ) {
$section_priority = apply_filters( 'busiprof_section_priority', 11, 'webriti_companion_busiprof_project' );
add_action( 'busiprof_home_template_sections', 'webriti_companion_busiprof_project', absint( $section_priority ) );
}