...
function webriti_companion_busiprof_testimonial_section( $wp_customize ) {
	...
	$wp_customize->add_setting( 'busiprof_theme_options[home_testimonial_section_enabled]', array( 
        'default' => 'on' , 
        'type' => 'option', 
	...
	$wp_customize->add_setting( 'busiprof_theme_options[testimonials_title]', array( 
        'default' => esc_html__('Aliquam erat vol', 'webriti-companion' ) , 
        'type'=>'option', 
	...
	$wp_customize->add_setting( 'busiprof_theme_options[testimonials_text]', array( 
        'default' => esc_html__('We are a group of passionate designers and developers', 'webriti-companion' ) , 
        'type'=>'option', 
...
add_action( 'customize_register', 'webriti_companion_busiprof_testimonial_section' );

function webriti_companion_busiprof_testi_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_busiprof_testi_section_partials' );	


if ($theme->name == 'vdequator' && (version_compare(wp_get_theme()->get('Version'), '1.0.9') > 0)):

    if (!function_exists('webriti_companion_vdequator_testimonial_layout_customizer')) {

        function webriti_companion_vdequator_testimonial_layout_customizer($wp_customize) {
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[testimonial_effect_layout_setting]', array(
    ...
    add_action('customize_register', 'webriti_companion_vdequator_testimonial_layout_customizer');
    
endif;

if ($theme->name == 'LazyProf' && (version_compare(wp_get_theme()->get('Version'), '1.2.5') > 0)):

    if (!function_exists('webriti_companion_lazyprof_testimonial_layout_customizer')) {

        function webriti_companion_lazyprof_testimonial_layout_customizer($wp_customize) {
            $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data());
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[testimonial_sideline_effect_layout_setting]', array(
                'label' => esc_html__('Testimonial Layout Setting', 'webriti-companion'),
                'section' => 'testimonial_settings',
                'choices' => array(
                    'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_lazyprof_testimonial_layout_customizer');
    
endif;

if ($theme->name == 'vdperanto' && (version_compare(wp_get_theme()->get('Version'), '2.0', '>=') )):

    if (!function_exists('webriti_companion_vdperanto_testimonial_layout_customizer')) {

        function webriti_companion_vdperanto_testimonial_layout_customizer($wp_customize) {
            $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data());
            ...
            $wp_customize->add_control(new Webriti_Companion_Image_Radio_Button($wp_customize, 'busiprof_theme_options[testimonial_center_effect_layout_setting]', array(
                'label' => esc_html__('Testimonial Layout Setting', 'webriti-companion'),
                'section' => 'testimonial_settings',
                'choices' => array(
                    'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_vdperanto_testimonial_layout_customizer');
