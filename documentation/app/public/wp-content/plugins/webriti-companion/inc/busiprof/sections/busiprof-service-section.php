...
function webriti_companion_busiprof_services() {
    ...
    if ($current_options['enable_services'] == "on") {
        if (!empty($current_options)) {
            if (empty($busiprof_service_content)) {
                ...
                if ($old_theme_servives['service_image_one'] != '' || $old_theme_servives['service_icon_one'] != '' || $old_theme_servives['service_title_one'] != '' || $old_theme_servives['service_text_one'] != '' || $old_theme_servives['service_image_two'] != '' || $old_theme_servives['service_icon_two'] != '' || $old_theme_servives['service_title_two'] != '' || $old_theme_servives['service_text_two'] != '' || $old_theme_servives['service_image_three'] != '' || $old_theme_servives['service_icon_three'] != '' || $old_theme_servives['service_title_three'] != '' || $old_theme_servives['service_text_three'] != '' || $old_theme_servives['service_image_four'] != '' || $old_theme_servives['service_icon_four'] != '' || $old_theme_servives['service_title_four'] != '' || $old_theme_servives['service_text_four'] != '') {
                    ...
                    $busiprof_service_content = wp_json_encode(array(
                        array(
        ...
        if (isset($current_options['service_effect_layout_setting']) && $theme->name=='vdequator') {
            if ($current_options['service_effect_layout_setting'] == 'default') {
                webriti_companion_busiprof_default_layout($busiprof_service_content); //default Lyout
            }
            if ($current_options['service_effect_layout_setting'] == 'slide_effect') {
                webriti_companion_busiprof_slide_layout($busiprof_service_content); //slide layout used in vdequator child
            }
        }
        if (isset($current_options['service_rotate_effect_layout_setting']) && $theme->name=='LazyProf') {
            ...
            if ($current_options['service_rotate_effect_layout_setting'] == 'rotate_effect') {
                webriti_companion_busiprof_rotate_layout($busiprof_service_content); //slide layout used in lazyprof child
            }
        }
        if (isset($current_options['service_blink_effect_layout_setting']) && $theme->name=='vdperanto') {
            ...
            if ($current_options['service_blink_effect_layout_setting'] == 'blink_effect') {
                webriti_companion_busiprof_blink_layout($busiprof_service_content); //slide layout used in lazyprof child
            }
        }
        ...
        if ($theme->name=='vdperanto' && !isset($current_options['service_blink_effect_layout_setting'])) {
            if(get_option('busiprof_user', 'new') == 'old' && (version_compare(wp_get_theme()->get('Version'), '2.0', '>='))){
                ...
                webriti_companion_busiprof_blink_layout($busiprof_service_content); //slide layout used in vdequator child
            }
        }
        ...
        if($theme->name == 'Busiprof Agency'){
            webriti_companion_busiprof_circle_layout($busiprof_service_content); //default Lyout
        }
    }
}


function webriti_companion_busiprof_rotate_layout($busiprof_service_content){
    $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data()); ?>
    <section id="section" class="service5 service">
        <div class="container">
            ...
            <?php webriti_companion_busiprof_service_content($busiprof_service_content); ?>
...
function webriti_companion_busiprof_slide_layout($busiprof_service_content) {
    $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data()); ?>
...
function webriti_companion_busiprof_default_layout($busiprof_service_content) {
    $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data()); ?>
...
function webriti_companion_busiprof_blink_layout($busiprof_service_content) {
    $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data()); ?>
...
function webriti_companion_busiprof_circle_layout($busiprof_service_content) {
    $current_options = wp_parse_args(get_option('busiprof_theme_options', array()), busiprof_theme_setup_data()); ?>
 ...
 */
if(!function_exists('webriti_companion_busiprof_service_content')){
    function webriti_companion_busiprof_service_content($busiprof_service_content, $is_callback = false) {
        if (!$is_callback) { ?>
                                ...
                                <?php if (!empty($link)) : ?>
                                    <a href="<?php echo esc_url($link); ?>">
                                        ...
                                        <?php if ($features_item->choice == 'customizer_repeater_icon') { ?>
                                            <?php if (!empty($icon)) : ?>
                                                <div class="service-icon" <?php if (!empty($color)) { echo 'style="color:' . esc_attr($color) . '"'; } ?>>
...
if (function_exists('webriti_companion_busiprof_services')) {
    $section_priority = apply_filters('busiprof_section_priority', 11, 'webriti_companion_busiprof_services');
    add_action('busiprof_home_template_sections', 'webriti_companion_busiprof_services', absint($section_priority));
