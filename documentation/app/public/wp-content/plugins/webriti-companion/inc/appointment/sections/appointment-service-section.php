...
if (!function_exists('webriti_companion_appointment_services')) :

    function webriti_companion_appointment_services() {
        $theme = wp_get_theme();
        ...
        if ($service_setting['service_section_enabled'] == 0 || $service_setting['service_section_enabled'] == '') {
            ...
            ?>
            <div class="<?php echo esc_attr($servicestyle); ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
...
if (function_exists('webriti_companion_appointment_services')) {
    $section_priority = apply_filters('appointment_section_priority', 12, 'webriti_companion_appointment_services');
    add_action('appointment_sections', 'webriti_companion_appointment_services', absint($section_priority));
}
?>