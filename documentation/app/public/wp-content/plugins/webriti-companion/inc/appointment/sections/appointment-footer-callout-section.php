 ...
 */
if (!function_exists('webriti_companion_ap_dark_footer_callout_setting')) :

function webriti_companion_ap_dark_footer_callout_setting() {
...
if (function_exists('webriti_companion_ap_dark_footer_callout_setting')) {
    $appointment_dark_section_priority = apply_filters('appointment_dark_section_priority', 14, 'webriti_companion_ap_dark_footer_callout_setting');
    add_action('appointment_dark_sections', 'webriti_companion_ap_dark_footer_callout_setting', absint($appointment_dark_section_priority));
}
