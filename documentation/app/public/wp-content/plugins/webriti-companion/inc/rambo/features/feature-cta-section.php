...
function webriti_companion_rambo_cta_section( $wp_customize ) {
	...
	$wp_customize->add_setting('rambo_pro_theme_options[site_intro_descritpion]', array(
	...
	$wp_customize ->add_setting('rambo_pro_theme_options[site_intro_button_text]', array( 
	...
	$wp_customize->add_control('rambo_pro_theme_options[site_intro_button_text]', array (  
		'label' => esc_html__('Button Text','webriti-companion'),
		'section' => 'site_intro_settings',
		'type' => 'text',
	));
			
	$wp_customize ->add_setting('rambo_pro_theme_options[site_intro_button_link]', array( 
		'default' => '#',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'esc_url_raw',
		'type' => 'option',
	));
	$wp_customize->add_control('rambo_pro_theme_options[site_intro_button_link]', array(  
		'label' => esc_html__('Button Link','webriti-companion'),
		'section' => 'site_intro_settings',
		'type' => 'text',
	) );

	$wp_customize->add_setting('rambo_pro_theme_options[intro_button_target]', array(
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_cta_checkbox',
		'type' => 'option',
		'default'=> true ,
	));
	$wp_customize->add_control('rambo_pro_theme_options[intro_button_target]',array(
		'type' => 'checkbox',
		'label' => esc_html__('Open link in new tab','webriti-companion'),
		'section' => 'site_intro_settings',
	));
}
add_action( 'customize_register', 'webriti_companion_rambo_cta_section' );

/**
 * Add selective refresh for service title section controls.
 */
function webriti_companion_rambo_callout_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_rambo_callout_section_partials' );

function webriti_companion_rambo_cta_checkbox( $checked ) {
	// Boolean check.
