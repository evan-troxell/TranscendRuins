 ...
 */
if ( ! function_exists( 'webriti_companion_rambo_cta' ) ) :

	function webriti_companion_rambo_cta() {
		...
		<?php $oldData = get_option( 'rambo_pro_theme_options');
...
if ( function_exists( 'webriti_companion_rambo_cta' ) ) {
	$section_priority = apply_filters( 'honeypress_section_priority', 11, 'webriti_companion_rambo_cta' );
	add_action( 'rambo_business_template_sections', 'webriti_companion_rambo_cta', absint( $section_priority ) );
}