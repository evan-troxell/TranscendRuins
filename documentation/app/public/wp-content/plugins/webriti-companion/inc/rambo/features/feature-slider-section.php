...
function webriti_companion_rambo_slider_section( $wp_customize ) {
	...
	//Hide slider	
	$wp_customize->add_setting('rambo_pro_theme_options[home_banner_enabled]', array(
		'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_slider_checkbox',
		'type' => 'option',
	));
	$wp_customize->add_control('rambo_pro_theme_options[home_banner_enabled]', array(
	...
	$wp_customize->add_setting( 'rambo_pro_theme_options[slider_post]',array(
		'default' => WC__PLUGIN_URL.'/inc/rambo/img/slider.jpg',
		'sanitize_callback' => 'esc_url_raw',
		'type' => 'option',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'rambo_pro_theme_options[slider_post]', array(
		'type'        => 'upload',
	...
	$wp_customize->add_setting('rambo_pro_theme_options[slider_title]', array(
		'default'        => $slider_title,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_input_field_sanitize_text',
	...
	$wp_customize->add_setting('rambo_pro_theme_options[slider_text]', array(
		'default'        => $slider_text,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_input_field_sanitize_text',
		'transport' => $selective_refresh ? 'postMessage' : 'refresh',
	...
	$wp_customize->add_setting('rambo_pro_theme_options[slider_readmore_text]', array(
	...
	$wp_customize->add_setting('rambo_pro_theme_options[readmore_text_link]', array(
		'default'        => '#',
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'esc_url_raw',
		'type' => 'option',
	...
	$wp_customize->add_setting('rambo_pro_theme_options[readmore_target]', array(
		'default'        => false,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_slider_checkbox',
		'type' => 'option',
	...
	function webriti_companion_rambo_input_field_sanitize_text( $input ) {
		return wp_kses_post( force_balance_tags( $input ) );
	}
}
add_action( 'customize_register', 'webriti_companion_rambo_slider_section' );

/**
 * Add selective refresh for service title section controls.
 */
function webriti_companion_rambo_slider_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_rambo_slider_section_partials' );	

function webriti_companion_rambo_slider_checkbox( $checked ) {
	// Boolean check.
