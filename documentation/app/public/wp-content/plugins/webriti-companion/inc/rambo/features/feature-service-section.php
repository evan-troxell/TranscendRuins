...
function webriti_companion_rambo_customizer_service_panel( $wp_customize ) {
	...
	$wp_customize->add_setting('rambo_pro_theme_options[home_service_enabled]', array(
		'default' => false,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_service_checkbox',
		'type' => 'option'
	));
	...
	$wp_customize->add_setting('rambo_pro_theme_options[service_title]', array(
		...
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_service_sanitize_html',
		'type' => 'option',
	...
	function webriti_companion_rambo_service_sanitize_html( $input ) {
		return wp_kses_post( force_balance_tags( $input ) );
	}		
}
add_action( 'customize_register', 'webriti_companion_rambo_customizer_service_panel' );

/**
 * Add selective refresh for service title section controls.
 */
function webriti_companion_rambo_service_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_rambo_service_section_partials' );

function webriti_companion_rambo_service_checkbox( $checked ) {
	// Boolean check.
