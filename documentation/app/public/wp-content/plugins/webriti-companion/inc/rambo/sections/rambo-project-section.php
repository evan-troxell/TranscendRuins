 ...
 */
if ( ! function_exists( 'webriti_companion_rambo_project' ) ) :

	function webriti_companion_rambo_project() {
		$rambo_pro_theme_options = webriti_companion_rambo_project_data_setup();
...
if ( function_exists( 'webriti_companion_rambo_project' ) ) {
	$section_priority = apply_filters( 'honeypress_section_priority', 11, 'webriti_companion_rambo_project' );
	add_action( 'rambo_business_template_sections', 'webriti_companion_rambo_project', absint( $section_priority ) );
}

function webriti_companion_rambo_project_data_setup()
{	
