...
function webriti_companion_rambo_portfolio_section( $wp_customize ) {
	...
	$wp_customize->add_setting('rambo_pro_theme_options[project_protfolio_enabled]', array(
		'default' => false,
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_project_checkbox',
		'type' => 'option'
	));	
	...
	//Project Title
	$wp_customize->add_setting('rambo_pro_theme_options[project_heading_one]', array(
		'default' => esc_html__('Perspiciatis Unde','webriti-companion'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'webriti_companion_rambo_project_sanitize_html',
		'type' => 'option',
	...
	//Project Description 
 	$wp_customize->add_setting('rambo_pro_theme_options[project_tagline]', array(
	...
	//Projects one image
	$wp_customize->add_setting( 'rambo_pro_theme_options[project_one_thumb]',array(
		'default' => WC__PLUGIN_URL.'/inc/rambo/img/port1.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'rambo_pro_theme_options[project_one_thumb]', array(
	...
	//Project One Title
	$wp_customize->add_setting('rambo_pro_theme_options[project_one_title]', array(
	...
	//Projects two image
	$wp_customize->add_setting( 'rambo_pro_theme_options[project_two_thumb]',array(
		'default' => WC__PLUGIN_URL.'/inc/rambo/img/port2.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
 
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'rambo_pro_theme_options[project_two_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project two Title
	$wp_customize->add_setting('rambo_pro_theme_options[project_two_title]', array(
	...
	$wp_customize->add_setting('rambo_pro_theme_options[project_two_text]', array(
		'default'        => esc_html__('Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.','webriti-companion'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'rambo_input_field_sanitize_text',
		'type' => 'option',
	...
	//Projects two image
	$wp_customize->add_setting( 'rambo_pro_theme_options[project_three_thumb]',array(
		'default' => WC__PLUGIN_URL.'/inc/rambo/img/port3.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'rambo_pro_theme_options[project_three_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project three Title
	$wp_customize->add_setting('rambo_pro_theme_options[project_three_title]', array(
	...
	$wp_customize->add_setting('rambo_pro_theme_options[project_three_text]', array(
		'default'  => esc_html__('Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.','webriti-companion'),
		'capability' => 'edit_theme_options',
		'sanitize_callback' => 'rambo_input_field_sanitize_text',
		'type' => 'option',
	...
	//Projects Four image
	$wp_customize->add_setting( 'rambo_pro_theme_options[project_four_thumb]',array(
		'default' => WC__PLUGIN_URL.'/inc/rambo/img/port4.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'rambo_pro_theme_options[project_four_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project Four Title
	$wp_customize->add_setting('rambo_pro_theme_options[project_four_title]', array(
	...
	//Project One Description
	$wp_customize->add_setting('rambo_pro_theme_options[project_four_text]', array(
		'default'        => esc_html__('Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.','webriti-companion'),
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'rambo_input_field_sanitize_text',
		'type' => 'option',
	...
	function webriti_companion_rambo_project_sanitize_html( $input ) {
		return wp_kses_post( force_balance_tags( $input ) );
	}
}

function webriti_companion_rambo_project_checkbox( $checked ) {
	// Boolean check.
	return ( ( isset( $checked ) && true == $checked ) ? true : false );
}
add_action( 'customize_register', 'webriti_companion_rambo_portfolio_section' );