 ...
 */
if ( ! function_exists( 'webriti_companion_spasalon_product' ) ) :
	function webriti_companion_spasalon_product() {
		$spa_theme_options= webriti_companion_spasalon_portfolio_data_setup(); 
					...
					<?php else: ?> 
						<div class="col-md-12 col-xs-12">
							<div class="product">
								...
								<?php if($current_theme_content['product_one_thumb'] || $current_theme_content['product_one_title'] || $current_theme_content['product_one_desc']):?>
...
if ( function_exists( 'webriti_companion_spasalon_product' ) ) {
	$section_priority = apply_filters( 'spasalon_section_priority', 11, 'webriti_companion_spasalon_product' );
	add_action( 'spasalon_sections', 'webriti_companion_spasalon_product', absint( $section_priority ) );
}
function webriti_companion_spasalon_portfolio_data_setup()
{	
