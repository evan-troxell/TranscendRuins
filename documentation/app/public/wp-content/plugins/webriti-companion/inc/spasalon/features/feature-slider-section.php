...
function webriti_companion_spasalon_slider_customizer( $wp_customize ) {
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[slider_post]', array(
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[slider_thumbnail_one]', array(
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[slider_thumbnail_two]', array(
		'label' => esc_html__('Thumbnail Image','webriti-companion'),
	...
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[slider_thumbnail_three]', array(
		'label' => esc_html__('Thumbnail Image','webriti-companion'),
 ...
 */
function webriti_companion_spasalon_slider_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_spasalon_slider_section_partials' );