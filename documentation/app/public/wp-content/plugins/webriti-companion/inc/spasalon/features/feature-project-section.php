...
function webriti_companion_spasalon_project_customizer( $wp_customize ){
	...
	//Project one image
	$wp_customize->add_setting( 'spa_theme_options[product_one_thumb]', array(
		'default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project1.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[product_one_thumb]', array(
	...
	//Project one Title
	$wp_customize->add_setting('spa_theme_options[product_one_title]', array(
	...
	$wp_customize->add_setting('spa_theme_options[product_one_desc]', array(
    ...
    $wp_customize->add_control('spa_theme_options[product_one_desc]', array(
        'label'   => esc_html__('Description', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));
	...
	//Project two image
	$wp_customize->add_setting( 'spa_theme_options[product_two_thumb]', array(
		'default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project2.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));	
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[product_two_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project Two Title
	$wp_customize->add_setting('spa_theme_options[product_two_title]', array(
        'default'        => esc_html__('Golden Cream','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	));
    $wp_customize->add_control('spa_theme_options[product_two_title]', array(
        'label'   => esc_html__('Title', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
    ));
	...
	$wp_customize->add_setting('spa_theme_options[product_two_desc]', array(
        'default'        => esc_html__('Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.', 'webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
    $wp_customize->add_control('spa_theme_options[product_two_desc]', array(
        'label'   => esc_html__('Description', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
    ));
	...
	//Project three image
	$wp_customize->add_setting( 'spa_theme_options[product_three_thumb]', array(
		'default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project3.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[product_three_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project Three Title
	$wp_customize->add_setting('spa_theme_options[product_three_title]', array(
        'default'        => esc_html__('Facial Toner','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
    $wp_customize->add_control('spa_theme_options[product_three_title]', array(
        'label'   => esc_html__('Title','webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));
	...
	$wp_customize->add_setting('spa_theme_options[product_three_desc]', array(
        'default'        => esc_html__('Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	));
    $wp_customize->add_control('spa_theme_options[product_three_desc]', array(
        'label'   => esc_html__('Description', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));	
	...
	//Project Four image
	$wp_customize->add_setting( 'spa_theme_options[product_four_thumb]', array(
		'default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project4.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[product_four_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
		'section' => 'example_section_one',
	...
	//Project Four Title
	$wp_customize->add_setting('spa_theme_options[product_four_title]', array(
        'default'        => esc_html__('Premium Cleanser','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	));
    $wp_customize->add_control('spa_theme_options[product_four_title]', array(
        'label'   => esc_html__('Title', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
    ));
	...
	$wp_customize->add_setting('spa_theme_options[product_four_desc]', array(
        'default'        => esc_html__('Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	));
    $wp_customize->add_control('spa_theme_options[product_four_desc]', array(
        'label'   => esc_html__('Description', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));	
	...
	//Project five image
	$wp_customize->add_setting( 'spa_theme_options[product_five_thumb]', array(
		'default' => WC__PLUGIN_URL .'/inc/spasalon/images/portfolio/project5.jpg',
		'type' => 'option',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'spa_theme_options[product_five_thumb]', array(
		'label' => esc_html__('Image','webriti-companion'),
	...
	//Project five Title
	$wp_customize->add_setting('spa_theme_options[product_five_title]',array(
        'default'        => esc_html__('Silver Cleanser','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
    ));
    $wp_customize->add_control('spa_theme_options[product_five_title]', array(
        'label'   => esc_html__('Title', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));
	...
	$wp_customize->add_setting('spa_theme_options[product_five_desc]', array(
        'default'        => esc_html__('Cras hendrerit mi quis nisi semper in sodales nisl faucibus. Sed quis quam eu ante ornare hendrerit.','webriti-companion'),
        'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
		'type' => 'option',
	));
    $wp_customize->add_control('spa_theme_options[product_five_desc]', array(
        'label'   => esc_html__('Description', 'webriti-companion'),
        'section' => 'project_section_settings',
		'type' => 'text',
	));
 ...
 */
function webriti_companion_spasalon_project_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_spasalon_project_section_partials' );