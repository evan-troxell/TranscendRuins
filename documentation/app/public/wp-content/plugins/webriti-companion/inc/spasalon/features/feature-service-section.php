...
if ( ! function_exists( 'webriti_companion_spasalon_service_customize' ) ) :
	function webriti_companion_spasalon_service_customize($wp_customize){
		...
		if ( class_exists( 'Webriti_Companion_Repeater' ) ) {
			...
			$wp_customize->add_control(new Webriti_Companion_Repeater($wp_customize, 'spa_theme_options[spasalon_service_content]', array(
	...
	add_action( 'customize_register', 'webriti_companion_spasalon_service_customize' );

	/**
	 * Add selective refresh for Front page section section controls.
	 */
	function webriti_companion_spasalon_service_section_partials( $wp_customize ){
	...
	add_action( 'customize_register', 'webriti_companion_spasalon_service_section_partials' );
endif;