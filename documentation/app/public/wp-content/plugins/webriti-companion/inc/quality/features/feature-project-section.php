...
function webriti_companion_quality_project_customizer($wp_customize) {
    ...
    $wp_customize->add_setting('quality_pro_options[home_projects_enabled]', array(
        'default' => true,
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'quality_sanitize_checkbox',
        'type' => 'option',
    ));
    $wp_customize->add_control('quality_pro_options[home_projects_enabled]', array(
    ...
    // //Project Title
    $wp_customize->add_setting('quality_pro_options[project_heading_one]', array(
    ...
    //Project Description 
    $wp_customize->add_setting('quality_pro_options[project_tagline]', array(
    ...
    $wp_customize->add_setting('quality_pro_options[project_one_thumb]', array(
        'default' => WC__PLUGIN_URL . '/inc/quality/images/portfolio/home-port1.jpg',
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'quality_pro_options[project_one_thumb]', array(
    ...
    $wp_customize->add_setting('quality_pro_options[project_one_title]', array(
    ...
    $wp_customize->add_setting('quality_pro_options[project_one_desc]', array(
        'default' => esc_html__('Nunc, Placerat', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ));
    ...
    $wp_customize->add_setting('quality_pro_options[project_two_thumb]', array(
        'default' => WC__PLUGIN_URL . '/inc/quality/images/portfolio/home-port2.jpg', 
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'quality_pro_options[project_two_thumb]',array(
        'label' => esc_html__('Image', 'webriti-companion'),
        'section' => 'example_section_one',
    ...
    $wp_customize->add_setting('quality_pro_options[project_two_title]', array(
        'default' => esc_html__('Cras tempus', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_two_desc]', array(
        'default' => esc_html__('Nunc, Placerat', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_three_thumb]', array(
        'default' => WC__PLUGIN_URL . '/inc/quality/images/portfolio/home-port3.jpg', 
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'quality_pro_options[project_three_thumb]', array(
        'label' => esc_html__('Image', 'webriti-companion'),
        'section' => 'example_section_one',
    ...
    $wp_customize->add_setting('quality_pro_options[project_three_title]', array(
        'default' => esc_html__('Cras tempus', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_three_desc]', array(
        'default' => esc_html__('Nunc, Placerat', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_four_thumb]', array(
        'default' => WC__PLUGIN_URL . '/inc/quality/images/portfolio/home-port4.jpg', 
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize,'quality_pro_options[project_four_thumb]',array(
        'label' => esc_html__('Image', 'webriti-companion'),
        'section' => 'example_section_one',
    ...
    $wp_customize->add_setting('quality_pro_options[project_four_title]', array(
        'default' => esc_html__('Cras tempus', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_four_desc]', array(
        'default' => esc_html__('Nunc, Placerat', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_five_thumb]', array(
        'default' => WC__PLUGIN_URL . '/inc/quality/images/portfolio/home-port5.jpg', 
        'type' => 'option', 
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'quality_pro_options[project_five_thumb]', array(
        'label' => esc_html__('Image', 'webriti-companion'),
    ...
    $wp_customize->add_setting('quality_pro_options[project_five_title]', array(
        'default' => esc_html__('Cras tempus', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
        'type' => 'option',
    ...
    $wp_customize->add_setting('quality_pro_options[project_five_desc]', array(
 ...
 */
function webriti_companion_quality_project_section_partials($wp_customize) {
...
add_action('customize_register', 'webriti_companion_quality_project_section_partials');