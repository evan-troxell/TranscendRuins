...
if (!function_exists('webriti_companion_quality_testimonial')) :
    function webriti_companion_quality_testimonial() {
        ...
        if ($funfact_enable == true) {
            ...
            <?php } ?>
                <div class="container">
                    <?php
                    $quality_pro_options = webriti_companion_quality_testimonial_data_setup();
                    ...
                    $testimonial_descripton = get_theme_mod('testimonial_descripton', esc_html__('Sed ut Perspiciatis Unde Omnis Iste Sed ut perspiciatis  unde omnis iste natu error sit voluptatem accu tium	neque fermentum veposu miten a tempor nise. Duis autem vel eum iriure dolor in hendrerit in vulputate velit consequat in velit esse.','webriti-companion'));
...
if (function_exists('webriti_companion_quality_testimonial')) {
    $section_priority = apply_filters('quality_section_priority', 14, 'webriti_companion_quality_testimonial');
    add_action('quality_sections', 'webriti_companion_quality_testimonial', absint($section_priority));
}

function webriti_companion_quality_testimonial_data_setup() {
