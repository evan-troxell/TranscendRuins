...
function webriti_companion_quality_funfact_customizer( $wp_customize ) {
	...
	if(class_exists('Webriti_Companion_Customize_Alpha_Color_Control'))
	{
		$wp_customize->add_setting( 'funfact_overlay_section_color', array(
			'sanitize_callback' => 'sanitize_text_field',
			'default' => 'rgba(0,0,0,0.85)',
      ));	    
		$wp_customize->add_control(new Webriti_Companion_Customize_Alpha_Color_Control( $wp_customize,'funfact_overlay_section_color', array(
...
add_action( 'customize_register', 'webriti_companion_quality_funfact_customizer' );

/**
 * Add selective refresh for Front page section section controls.
 */
function webriti_companion_quality_funfact_section_partials( $wp_customize ){
...
add_action( 'customize_register', 'webriti_companion_quality_funfact_section_partials' );

// Quality default funfact content data
if ( ! function_exists( 'webriti_companion_quality_funfact_default_customize' ) ) :
	function webriti_companion_quality_funfact_default_customize( $wp_customize ){
		$quality_funfact_content_control = $wp_customize->get_setting( 'quality_funfact_content' );
		if ( ! empty( $quality_funfact_content_control ) ) {
			$quality_funfact_content_control->default = wp_json_encode( array(
				array(
	...
	add_action( 'customize_register', 'webriti_companion_quality_funfact_default_customize' );
endif;