...
if ( ! function_exists( 'webriti_companion_quality_funfact' ) ) :

	function webriti_companion_quality_funfact() {
		...
		if($funfact_enable == true){
			...
			<?php } 
				...
				<div class="overlay"<?php if($funfact_image_overlay != false) { ?>style="background-color:<?php echo esc_attr($funfact_overlay_section_color); } ?>">
					<div class="container">
						<div class="row ">
							<?php if ( ! empty( $quality_funfact_content ) ) {
								$allowed_html = array(
									'br'     => array(),
									'em'     => array(),
									'strong' => array(),
								...
								<div class="col-lg-3 col-md-3 col-sm-6">	
									<div class="funfact-inner text-center">
										...
										<h1 class="funfact-title"><?php echo esc_html__('2500','webriti-companion'); ?></h1>
								...
								<div class="col-lg-3 col-md-3 col-sm-6">		
									<div class="funfact-inner text-center">
										...
										<h1 class="funfact-title"><?php echo esc_html__('90%','webriti-companion'); ?></h1>
								...
								<div class="col-lg-3 col-md-3 col-sm-6">			
									<div class="funfact-inner text-center">
										...
										<h1 class="funfact-title"> <?php echo esc_html__('1350','webriti-companion'); ?></h1>
...
if ( function_exists( 'webriti_companion_quality_funfact' ) ) {
	$section_priority = apply_filters( 'quality_section_priority', 11, 'webriti_companion_quality_funfact' );
	add_action( 'quality_sections', 'webriti_companion_quality_funfact', absint( $section_priority ) );
}