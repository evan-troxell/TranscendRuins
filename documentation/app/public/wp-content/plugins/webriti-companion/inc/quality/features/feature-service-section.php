...
if (!function_exists('webriti_companion_quality_service_customize')) :

    function webriti_companion_quality_service_customize($wp_customize) {
        ...
        $wp_customize->add_setting('quality_pro_options[service_enable]', array(
            'default' => true,
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'quality_sanitize_checkbox',
            'type' => 'option',
        ));
        $wp_customize->add_control('quality_pro_options[service_enable]', array(
            'label' => esc_html__('Enable Services on homepage.', 'webriti-companion'),
            'section' => 'service_settings',
            'type' => 'checkbox',
        ));

        $wp_customize->add_setting('quality_pro_options[service_title]', array(
            'default' => esc_html__('Nam suscipit libero', 'webriti-companion'),
            'capability' => 'edit_theme_options',
            'type' => 'option',
            'sanitize_callback' => 'sanitize_text_field'
        ));
        $wp_customize->add_control('quality_pro_options[service_title]', array(
            'label' => esc_html__('Title', 'webriti-companion'),
            'section' => 'service_settings',
            'type' => 'text',
        ));

        $wp_customize->add_setting('quality_pro_options[service_description]',array(
            'default' => __('Curabitur <b>lacinia</b> tellus', 'webriti-companion'),
            'type' => 'option',
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'wp_kses_post'
        ));
        $wp_customize->add_control('quality_pro_options[service_description]',array(
    ...
    add_action('customize_register', 'webriti_companion_quality_service_customize');

    /**
     * Add selective refresh for Front page section section controls.
     */
    function webriti_companion_quality_service_section_partials($wp_customize) {
    ...
    add_action('customize_register', 'webriti_companion_quality_service_section_partials');
endif;
...
if ($theme->name == 'Quality blue' && (version_compare(wp_get_theme()->get('Version'), '1.5.9') > 0)):
    ...
    function webriti_companion_qblue_service_slide_customizer($wp_customize) {
         ...
         */
        class Webriti_Companion_Qblue_Img_Radio_Btn_Service_Custom_Control extends WP_Customize_Control {
        ...
        $quality_options = webriti_companion_quality_theme_data_setup();
        ...
        $wp_customize->add_control(new Webriti_Companion_Qblue_Img_Radio_Btn_Service_Custom_Control($wp_customize, 'quality_pro_options[service_blink_layout_setting]', array(
    ...
    add_action('customize_register', 'webriti_companion_qblue_service_slide_customizer');
endif;

// Quality Green Service Layout Setting
if ($theme->name == 'Quality green' && version_compare(wp_get_theme()->get('Version'), '1.2.7') > 0):

    function webriti_companion_qgreen_service_slide_customizer($wp_customize) {
         ...
         * @link https://github.com/maddisondesigns
         */
        class Webriti_Companion_Qgreen_Img_Radio_Btn_Service_Custom_Control extends WP_Customize_Control {
        ...
        $current_options = wp_parse_args(get_option('quality_pro_options', array()), webriti_companion_quality_theme_data_setup());
        ...
        $wp_customize->add_control(new Webriti_Companion_Qgreen_Img_Radio_Btn_Service_Custom_Control($wp_customize, 'quality_pro_options[service_box_layout_setting]',array(
            'label' => esc_html__('Service Layout Setting', 'webriti-companion'),
            'section' => 'service_settings',
            'choices' => array(
                'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_qgreen_service_slide_customizer');
endif;

// Quality Orange Service Layout Setting
if ($theme->name == 'Quality orange' && version_compare(wp_get_theme()->get('Version'), '1.1.9.2') > 0):

    function webriti_companion_qorange_service_slide_customizer($wp_customize) {
         ...
         * @link https://github.com/maddisondesigns
         */
        class Webriti_Companion_Qorange_Img_Radio_Btn_Service_Custom_Control extends WP_Customize_Control {
        ...
        $wp_customize->add_control(new Webriti_Companion_Qorange_Img_Radio_Btn_Service_Custom_Control($wp_customize, 'quality_pro_options[service_rotate_layout_setting]',array(
                    'label' => esc_html__('Service Layout Setting', 'webriti-companion'),
                    'section' => 'service_settings',
                    'choices' => array(
                        'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_qorange_service_slide_customizer');
endif;

// Heroic Service Layout Setting
if ($theme->name == 'Heroic' && version_compare(wp_get_theme()->get('Version'), '1.2.1') > 0):

    function webriti_companion_heroic_service_slide_customizer($wp_customize) {
         ...
         * @link https://github.com/maddisondesigns
         */
        class Webriti_Companion_Heroic_Img_Radio_Btn_Service_Custom_Control extends WP_Customize_Control {
        ...
        $wp_customize->add_control(new Webriti_Companion_Heroic_Img_Radio_Btn_Service_Custom_Control($wp_customize, 'quality_pro_options[service_slide_layout_setting]', array(
            'label' => esc_html__('Service Layout Setting', 'webriti-companion'),
            'section' => 'service_settings',
            'choices' => array(
                'default' => array(
    ...
    add_action('customize_register', 'webriti_companion_heroic_service_slide_customizer');
endif;