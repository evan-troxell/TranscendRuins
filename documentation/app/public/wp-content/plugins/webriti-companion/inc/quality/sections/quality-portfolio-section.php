 ...
 */
if (!function_exists('webriti_companion_quality_portfolio')) :

    function webriti_companion_quality_portfolio() {

        $quality_pro_options = webriti_companion_quality_portfolio_data_setup();
                        ...
                        <div class="row">
                            <div class="section-header">
                                ...
                                if (!empty($quality_portfolio_title) || is_customize_preview()) {
                                    echo '<p>' . esc_html($quality_portfolio_title) . '</9>';
                                }
                                if (!empty($quality_portfolio_subtitle) || is_customize_preview()) {
                                    echo '<h1 class="widget-title">' . wp_kses_post($quality_portfolio_subtitle) . '</h1>';
                                }
                    ...
                    <div class="row p-left-right-0">
                        <div class="col">	
                            <article class="post" id="quality_project_one">
                                ...
                                <a href="<?php echo esc_url($current_theme_content['project_one_thumb']); ?>" data-lightbox="image" title="<?php echo esc_attr($current_theme_content['project_one_title']); ?>"><i class="fa fa-search "></i></a>
                            </article>
                        </div>
                        ...
                        <div class="col">	
                            <article class="post" id="quality_project_two">
                                ...
                                <a href="<?php echo esc_url($current_theme_content['project_two_thumb']); ?>" data-lightbox="image" title="<?php echo esc_attr($current_theme_content['project_two_title']); ?>"><i class="fa fa-search "></i></a>
                            </article>
                        </div>
                        ...
                        <div class="col">	
                            <article class="post" id="quality_project_three">
                                ...
                                <a href="<?php echo esc_url($current_theme_content['project_three_thumb']); ?>" data-lightbox="image" title="<?php echo esc_attr($current_theme_content['project_three_title']); ?>"><i class="fa fa-search "></i></a>
                            </article>
                        </div>
                        ...
                        <div class="col">	
                            <article class="post" id="quality_project_four">
                                ...
                                <a href="<?php echo esc_url($current_theme_content['project_four_thumb']); ?>" data-lightbox="image" title="<?php echo esc_attr($current_theme_content['project_four_title']); ?>"><i class="fa fa-search "></i></a>
                            </article>
                        </div>
                        ...
                        <div class="col">	
                            <article class="post" id="quality_project_five">
                                ...
                                <a href="<?php echo esc_url($current_theme_content['project_five_thumb']); ?>" data-lightbox="image" title="<?php echo esc_attr($current_theme_content['project_five_title']); ?>"><i class="fa fa-search "></i></a>
                            </article>
                        </div>	
                    </div>
                </div>
...
if (function_exists('webriti_companion_quality_portfolio')) {
    $section_priority = apply_filters('quality_section_priority', 12, 'webriti_companion_quality_portfolio');
    add_action('quality_sections', 'webriti_companion_quality_portfolio', absint($section_priority));
}

function webriti_companion_quality_portfolio_data_setup() {
