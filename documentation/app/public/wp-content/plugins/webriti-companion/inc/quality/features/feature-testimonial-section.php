...
function webriti_companion_quality_testimonial_customizer($wp_customize) {

    $wp_customize->add_section('test_section_settings',array(
    ...
    $wp_customize->add_setting('quality_pro_options[home_testimonial_title]',array(
    ...
    $wp_customize->add_setting('quality_pro_options[home_testimonial_desciption]',array(
    ...
    $wp_customize->add_setting('testimonial_descripton',array(
        'default' => esc_html__('Sed ut Perspiciatis Unde Omnis Iste Sed ut perspiciatis unde omnis iste natu error sit voluptatem accu tium neque fermentum veposu miten a tempor nise. Duis autem vel eum iriure dolor in hendrerit in vulputate velit consequat in velit esse.', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    ...
    $wp_customize->add_setting('testimonial_name', array(
        'default' => esc_html__('Elementum Nulla', 'webriti-companion'),
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    ...
    $wp_customize->add_setting('testimonial_position',array(
...
add_action('customize_register', 'webriti_companion_quality_testimonial_customizer');

/**
 * Add selective refresh for Front page testimonial section controls.
 */
function webriti_companion_quality_testimonial_section_partials($wp_customize) {
...
add_action('customize_register', 'webriti_companion_quality_testimonial_section_partials');