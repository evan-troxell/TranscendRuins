 ...
 */
 if (!function_exists('webriti_companion_wallstreet_portfolio_section')) :

	function webriti_companion_wallstreet_portfolio_section() {
...
if (function_exists('webriti_companion_wallstreet_portfolio_section')) {
	$section_priority = apply_filters('wallstreet_section_priority', 12, 'webriti_companion_wallstreet_portfolio_section');
	add_action('wallstreet_sections', 'webriti_companion_wallstreet_portfolio_section', absint($section_priority));
}