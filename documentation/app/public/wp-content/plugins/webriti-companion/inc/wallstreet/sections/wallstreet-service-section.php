 ...
 */
if (!function_exists('webriti_companion_wallstreet_service_section')) :

    function webriti_companion_wallstreet_service_section() {
        $theme = wp_get_theme();
        ...
        if ($current_options['service_section_enabled'] == true) { ?>
            ...
            <div class="service-section">
                <div class="container">
                    ...
                    ?>
                    <div class="row <?php echo esc_attr($service_row_class); ?>">
                        <?php $service_title_array = array($current_options['service_title_one'], $current_options['service_title_two'], $current_options['service_title_three']);
...
if (function_exists('webriti_companion_wallstreet_service_section')) {
    $section_priority = apply_filters('wallstreet_section_priority', 11, 'webriti_companion_wallstreet_service_section');
    add_action('wallstreet_sections', 'webriti_companion_wallstreet_service_section', absint($section_priority));
}
