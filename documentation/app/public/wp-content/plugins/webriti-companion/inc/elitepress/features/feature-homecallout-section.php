...
function webriti_companion_elitepress_callout_customizer( $wp_customize ){	
	
	//Home top callout
	$wp_customize->add_section('header_home_callout',array(
	...
	//Hide Top Callout
	$wp_customize->add_setting('elitepress_lite_options[topcalout_section_enabled]', array(
		'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'elitepress_sanitize_checkbox',
		'type' => 'option'
    ));
	$wp_customize->add_control('elitepress_lite_options[topcalout_section_enabled]', array(
	...
	$wp_customize->add_setting('elitepress_lite_options[header_call_out_title]', array(
	...
	$wp_customize->add_setting('elitepress_lite_options[header_call_out_description]', array(
	...
	$wp_customize->add_setting('elitepress_lite_options[header_call_out_btn_text]', array(
...
add_action( 'customize_register', 'webriti_companion_elitepress_callout_customizer' );