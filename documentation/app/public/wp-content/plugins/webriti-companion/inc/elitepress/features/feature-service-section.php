...
function webriti_companion_elitepress_service_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting('elitepress_lite_options[service_section_enabled]', array(
        'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'elitepress_sanitize_checkbox',
		'type' => 'option'
    ));
	$wp_customize->add_control('elitepress_lite_options[service_section_enabled]', array(
        'label' => esc_html__('Enable Service section on front page','webriti-companion'),
        'section' => 'service_section_settings',
        'type' => 'checkbox',
    ));
	
	$wp_customize->add_setting('elitepress_lite_options[service_title]', array(
	...
	$wp_customize->add_setting('elitepress_lite_options[service_description]', array(
...
add_action( 'customize_register', 'webriti_companion_elitepress_service_customizer' );

// Elitepress default service data.
if ( ! function_exists( 'webriti_companion_elitepress_service_default_customize' ) ) :
	
	function webriti_companion_elitepress_service_default_customize( $wp_customize ) {
		...
		if(get_option('elitepress_lite_options')!=''){
			...
			if($old_theme_servives['service_one_icon']!= '' || $old_theme_servives['service_one_title']!= '' || $old_theme_servives['service_one_description']!= '' || $old_theme_servives['service_two_icon']!= '' || $old_theme_servives['service_two_title']!= '' || $old_theme_servives['service_two_description']!= '' || $old_theme_servives['service_three_icon']!= '' || $old_theme_servives['service_three_title']!= '' || $old_theme_servives['service_three_description']!= '' || $old_theme_servives['service_four_icon']!= '' || $old_theme_servives['service_four_title']!= '' || $old_theme_servives['service_four_description']!= '') {
				...
				if ( ! empty( $elitepress_service_content_control ) ) {
					$elitepress_service_content_control->default = wp_json_encode( array(
						array(
	...
	add_action( 'customize_register', 'webriti_companion_elitepress_service_default_customize' );
endif;