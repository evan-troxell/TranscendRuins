...
if (!function_exists('webriti_companion_elitepress_top_call_out')) :
	function webriti_companion_elitepress_top_call_out() {
...
if (function_exists('webriti_companion_elitepress_top_call_out')) {
    $section_priority = apply_filters('elitepresss_section_priority', 12, 'webriti_companion_elitepress_top_call_out');
    add_action('elitepress_sections', 'webriti_companion_elitepress_top_call_out', absint($section_priority));
}