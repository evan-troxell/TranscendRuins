...
if (!function_exists('webriti_companion_elitepress_portfolio')) :
	function webriti_companion_elitepress_portfolio() {
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="section-header">
								...
								<?php } if($current_options['front_portfolio_description']) { ?>
										...
										<header class="entry-header">
											<?php if($current_options['portfolio_one_title']){ ?>
												<h4 class="entry-title">
													<?php echo esc_html($current_options['portfolio_one_title']); ?>
												</h4>
											<?php } ?>
										</header>					
										<?php if($current_options['portfolio_one_description']){ ?>
											<div class="entry-content">
												<p><?php echo esc_html($current_options['portfolio_one_description']);?> <?php } ?>
												</p>
											</div>
									</div>
								</article>
								...
								<article class="portfolio-area">
									...
									<div class="portfolio-info">
										...
										<?php if($current_options['portfolio_two_description']){ ?>
											<div class="entry-content">
												<p><?php echo esc_html($current_options['portfolio_two_description']);?>
												<?php } ?></p>
											</div>
									</div>
								</article>
							...
							<div class="col-md-4 col-sm-6 col-xs-12">
								<article class="portfolio-area">
									...
									<div class="portfolio-info">
										...
										<div class="entry-content">
											<p><?php echo esc_html($current_options['portfolio_three_description']);?>
											<?php } ?></p>
										</div>
									</div>
								</article>
...
if (function_exists('webriti_companion_elitepress_portfolio')) {
    $section_priority = apply_filters('elitepresss_section_priority', 14, 'webriti_companion_elitepress_portfolio');
    add_action('elitepress_sections', 'webriti_companion_elitepress_portfolio', absint($section_priority));
}